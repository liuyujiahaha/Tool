...
- (void)setupUI {
    self.title = iStoreLocalizedString(@"相册");
    self.view.backgroundColor = [UIColor whiteColor];
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithTitle:iStoreLocalizedString(@"取消") style:UIBarButtonItemStylePlain target:self action:@selector(cancelClick)];
