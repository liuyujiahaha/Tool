...
- (void)setupUI {
    ...
    [rightBtn setTitle:[NSBundle hx_localizedStringForKey:iStoreLocalizedString(@"确定")] forState:UIControlStateNormal];
    ...
    if (self.photoManager.singleSelecteClip) {
        self.navItem.title = [NSBundle hx_localizedStringForKey:iStoreLocalizedString(@"裁剪")];
        
        self.editView = [[HXPhotoEditView alloc] initWithFrame:self.bgView.frame];
        [self.view addSubview:self.editView];
    }else {
        self.navItem.title = [NSBundle hx_localizedStringForKey:iStoreLocalizedString(@"预览")];
    }
    [self setupModel];
