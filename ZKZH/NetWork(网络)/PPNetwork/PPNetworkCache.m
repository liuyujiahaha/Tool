...
+ (void)setHttpCache:(id)httpData URL:(NSString *)URL parameters:(NSDictionary *)parameters {
    NSMutableDictionary *dicM = [NSMutableDictionary dictionaryWithDictionary:parameters];
    //忽略timestamp和sign这两个参数
    [dicM setObject:@"" forKey:@"timestamp"];
    [dicM setObject:@"" forKey:@"sign"];
    NSString *cacheKey = [self cacheKeyWithURL:URL parameters:dicM];
    //异步缓存,不会阻塞主线程
